...
describe('ItemCatalogComponent', () => {
  ...
  beforeEach(() => {
    groceryServiceSpy = jasmine.createSpyObj('GroceryService', ['getGroceryItems', 'addToCart']);
  ...
  it('item-catalogComponent_should_create', () => {
    expect(component).toBeTruthy();
  });

  it('item-catalogComponent_should_load_item_catalog_on_init_and_display_properties_in_HTML', () => {
  ...
  it('item-catalogComponent_should_add_item_to_cart_when_addToCart_is_called', () => {
