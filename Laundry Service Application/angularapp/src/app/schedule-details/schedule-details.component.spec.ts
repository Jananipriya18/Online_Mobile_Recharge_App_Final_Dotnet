...
//     mockScheduleService = {
//       ['getSchedules']: () => of([
//         { id: 1, fullName: 'John Doe', mobileNumber: '123-456-7890', address: '123 Main St', pickupDay: 'Monday', pickupTimeSlot: '1-3pm' },
//         { id: 2, fullName: 'Jane Smith', mobileNumber: '987-654-3210', address: '456 Oak Ave', pickupDay: 'Tuesday', pickupTimeSlot: '5-7pm' },
//         { id: 3, fullName: 'Jane Smith', mobileNumber: '987-654-3210', address: '456 Oak Ave', pickupDay: 'Wednesday', pickupTimeSlot: '3-5pm' },
//       ]),
//     };
...
//   it('should fetch schedules on initialization', () => {
//     component.ngOnInit();
