...
describe('NavbarComponent', () => {
  ...
  fit('NavbarComponent should render two navigation links', () => {
    const linkElements = fixture.debugElement.queryAll(By.css('#nav-link'));
    expect(linkElements.length).toBe(2);
  });

  fit('NavbarComponent should have a link to "Schedule Form"', () => {
  ...
  fit('NavbarComponent should have a link to "Schedule Details"', () => {
